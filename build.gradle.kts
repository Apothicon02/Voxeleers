...
tasks.withType<Jar> {
    manifest {
        attributes["Main-Class"] = "org.voxeleers.Main"
    }
}
...
tasks {
    val fatJar = register<Jar>("fatJar") {
        ...
        manifest { attributes(mapOf("Main-Class" to "org.voxeleers.Main")) } // Provided we set it up in the application plugin configuration
