...
tasks.withType<Jar> {
    manifest {
        attributes["Main-Class"] = "org.archipelacraft.Main"
    }
}
...
tasks {
    val fatJar = register<Jar>("fatJar") {
        ...
        manifest { attributes(mapOf("Main-Class" to "org.archipelacraft.Main")) } // Provided we set it up in the application plugin configuration
