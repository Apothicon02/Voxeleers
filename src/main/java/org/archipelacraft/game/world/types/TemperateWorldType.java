...
import static org.archipelacraft.game.world.World.getLight;
        ...
        for (int x = 0; x < size; x++) {
            for (int z = 0; z < size; z++) {
                ...
                if (blockOn.x == 2) {
                    ...
                    if (randomNumber * 10 < foliageChanceExp && foliageType < ArchipelacraftMath.gradient(surface, 78, 86, 1, 0.002f)) {
