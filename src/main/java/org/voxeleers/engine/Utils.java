...
public class Utils {
    ...
    public static Vector3f getInterpolatedVec(Vector3f old, Vector3f current) {
        return new Vector3f(VoxeleersMath.mix(old.x, current.x, (float) Main.interpolationTime), VoxeleersMath.mix(old.y, current.y, (float) Main.interpolationTime), VoxeleersMath.mix(old.z, current.z, (float) Main.interpolationTime));
    }
    public static float getInterpolatedFloat(float old, float current) {
        return VoxeleersMath.mix(old, current, (float) Main.interpolationTime);
    }
