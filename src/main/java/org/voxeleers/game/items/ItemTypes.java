...
public class ItemTypes {
    ...
    public static ItemType
            ...
            POWERED_VENT = create(new ItemType("machine/texture/powered_vent").maxStackSize(4).blockToPlace(BlockTypes.getId(BlockTypes.POWERED_VENT), 0).sfx(new ItemSFX(new SFX[]{Sounds.METAL_SMALL_PLACE1, Sounds.METAL_SMALL_PLACE2}, 0.6f, 1.0f))),
