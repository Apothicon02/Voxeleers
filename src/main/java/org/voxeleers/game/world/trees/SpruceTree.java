package org.voxeleers.game.world.trees;

import kotlin.Pair;
import org.voxeleers.game.world.FeatureHelper;
import org.voxeleers.game.world.World;
import org.voxeleers.game.world.trees.canopies.SpruceCanopy;
import org.voxeleers.game.world.trees.trunks.StraightTrunk;
...
import static org.voxeleers.game.world.World.heightmap;
import static org.voxeleers.game.world.World.setLight;
    ...
    public static void generate(Vector2i blockOn, int x, int y, int z, int maxHeight, int logType, int logSubType, int leafType, int leafSubType) {
        if (blockOn.x == 2 || blockOn.x == 54) {
            ...
            for (Vector3i canopyPos : generatedTrunk.getSecond()) {
                Map<Vector3i, Vector2i> canopy = SpruceCanopy.generateCanopy(blocks, canopyPos.x, canopyPos.y, canopyPos.z, leafType, leafSubType, maxHeight, new Vector3i(x, y, z));
