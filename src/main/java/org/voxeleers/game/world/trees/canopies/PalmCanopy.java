package org.voxeleers.game.world.trees.canopies;
...
public class PalmCanopy extends Canopy {
    ...
    private static void createFrond(Map<Vector3i, Vector2i> map, Vector3i pos, Random random, int trunkDist, Vector3i origin, Vector3i treeOrigin, int northSouth, int eastWest) {
        addSquare(map, VoxeleersMath.addVec(pos, northSouth, 0, eastWest), random, 1, true, trunkDist, origin, treeOrigin);
        addSquare(map, VoxeleersMath.addVec(pos, northSouth, -1, eastWest), random, 1, true, trunkDist, origin, treeOrigin);

        for (int i = 3; i <= 5; i++) {
            addSquare(map, VoxeleersMath.addVec(pos, northSouth * i, 0, eastWest * i), random, 0, true, trunkDist, origin, treeOrigin);
            addSquare(map, VoxeleersMath.addVec(pos, northSouth * i, -1 , eastWest * i), random, 0, true, trunkDist, origin, treeOrigin);
            addSquare(map, VoxeleersMath.addVec(pos, northSouth * i, -2 , eastWest * i), random, 0, true, trunkDist, origin, treeOrigin);
        }

        addToMap(map, VoxeleersMath.addVec(pos, northSouth*6, -1, eastWest*6), random, trunkDist, origin, treeOrigin);
        addToMap(map, VoxeleersMath.addVec(pos, northSouth*6, -2, eastWest*6), random, trunkDist, origin, treeOrigin);
        addToMap(map, VoxeleersMath.addVec(pos, northSouth*6, -3, eastWest*6), random, trunkDist, origin, treeOrigin);
        addToMap(map, VoxeleersMath.addVec(pos, northSouth*6, -4, eastWest*6), random, trunkDist, origin, treeOrigin);

        addToMap(map, VoxeleersMath.addVec(pos, northSouth*7, -2, eastWest*7), random, trunkDist, origin, treeOrigin);
        addToMap(map, VoxeleersMath.addVec(pos, northSouth*7, -3, eastWest*7), random, trunkDist, origin, treeOrigin);
        addToMap(map, VoxeleersMath.addVec(pos, northSouth*7, -4, eastWest*7), random, trunkDist, origin, treeOrigin);
        addToMap(map, VoxeleersMath.addVec(pos, northSouth*7, -5, eastWest*7), random, trunkDist, origin, treeOrigin);
        addToMap(map, VoxeleersMath.addVec(pos, northSouth*7, -6, eastWest*7), random, trunkDist, origin, treeOrigin);
    }
